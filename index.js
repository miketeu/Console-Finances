...
// Code to print out length of dataset to index.html.
document.getElementById("totalMonths").innerHTML = "Total Months: " + finances.length;

console.log("Financial Analysis" );
console.log("------------------");

// Print number of months to console.
